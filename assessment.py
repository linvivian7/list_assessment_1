...
def all_odd(numbers):
    ...
    For example::
        ...
        []
    """
    # Append odd numbers (numbers for which mod 2 does not yield 0)
...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    """
    # Return intersection between the two sets via sorted list
...
def largest_n_items(items, n):
    ...
    # Yield empty set when specified n is non-positive
    if n <= 0:
        return []
    else:
        return items[-n:]
